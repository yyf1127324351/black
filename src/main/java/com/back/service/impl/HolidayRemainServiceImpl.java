...
public class HolidayRemainServiceImpl implements HolidayRemainService {
    ...
    @Override
    public BaseResponse getHolidayRemainList(HolidayRemainModel holidayRemainDto) {
        BaseResponse baseResponse = new BaseResponse();
        baseResponse.setTotal(holidayRemainDao.countHolidayRemain(holidayRemainDto));
        List<HolidayRemainModel> list = holidayRemainDao.getHolidayRemainList(holidayRemainDto);
